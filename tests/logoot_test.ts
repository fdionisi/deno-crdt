...
import { Document } from "../logoot/mod.ts";
...
Deno.test({
  name: "Logoot randomized operations",
  async fn() {
...
// FIXME: Random order delivery do not work
Deno.test({
  name: "Logoot randomized operations with delay",
  async fn() {
